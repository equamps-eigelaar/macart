...
import {
  ...
  Settings, BarChart3, Activity, LogOut, TrendingDown, Clock, Building2
} from "lucide-react";
...
const navGroups = [
  ...
  },
  {
    ...
    color: "text-cyan-400",
    items: [
      { label: "Maintenance Requests", path: "/MaintenanceRequests", icon: Wrench },
      { label: "PM Schedule", path: "/PMSchedule", icon: Clock },
    ]
  },
  {
    label: "Quality",
